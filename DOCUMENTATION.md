...
#### **Supported Formats**
1. **PPN (Picovoice)** - Professional, low RAM usage (RECOMMENDED for Pi Zero 2W)
2. **ONNX** - Custom trained model support
3. **TFLite** - TensorFlow Lite model (optional)
...
# GPIO button alternative
fably --gpio-button --loop
```

### GPIO Button System

Alternative to wakeword detection with zero RAM usage:

- **Single press**: Start voice recording
- **Double press**: Cycle voices (if voice-cycle enabled)  
