...
TRANSLATIONS = {
    'tr': {
        ...
        'wakeword_detection': '🎙️ Uyandırma Kelimesi Algılama',
        'wakeword_engine': 'Uyandırma Kelimesi Motoru',
        'wakeword_engine_info': 'Ses aktivasyon motoru (Pi Zero 2W için PPN önerilir)',
        'wakeword_model_path': 'Uyandırma Kelimesi Model Yolu',
        'wakeword_model_info': 'Uyandırma kelimesi model dosya yolu (.ppn, .onnx, .tflite)',
        'wakeword_sensitivity': 'Uyandırma Kelimesi Hassasiyeti',
        'wakeword_sensitivity_info': 'Algılama hassasiyeti (0.0=katı, 1.0=hassas)',
        'wakeword_disabled': 'Devre Dışı',
        'wakeword_ppn': 'PPN (Picovoice - Pi Zero 2W için Önerilir)',
        'wakeword_onnx': 'ONNX (Özel eğitilmiş modeller)',
        'wakeword_tflite': 'TFLite (TensorFlow Lite)',
        
        # GPIO Button Settings
        'gpio_button_controls': '🔘 GPIO Düğme Kontrolleri',
        'enable_gpio_button': 'GPIO Düğmesini Etkinleştir',
        'gpio_button_info': 'Fiziksel düğmeyi uyandırma kelimesi alternatifi olarak kullan',
        'gpio_pin_number': 'GPIO Pin Numarası',
        'gpio_pin_info': 'Düğme için GPIO pin (varsayılan: 17)',
        'enable_voice_cycling': 'Ses Döngüsünü Etkinleştir',
        'voice_cycling_info': 'Sesler arasında geçiş için düğmeye çift tıklayın',
        'long_press_duration': 'Uzun Basma Süresi (saniye)',
        'long_press_info': 'Kapatma komutu için tutma süresi',
    ...
    'en': {
        ...
        'stt_model_optional': 'STT Model ID (optional)',
        ...
        'stt_provider_info': 'Which provider to use for speech recognition',
        ...
        'auto_calibrate': 'Auto-Calibrate Noise Floor',
        'auto_calibrate_info': 'Automatically measure ambient noise on startup',
        'calibration_duration': 'Calibration Duration (seconds)',
        'calibration_duration_info': 'How long to measure ambient noise',
        
        # Wakeword Detection Settings
        'wakeword_detection': '🎙️ Wakeword Detection',
        'wakeword_engine': 'Wakeword Engine',
        'wakeword_engine_info': 'Voice activation engine (PPN recommended for Pi Zero 2W)',
        'wakeword_model_path': 'Wakeword Model Path',
        'wakeword_model_info': 'Path to wakeword model file (.ppn, .onnx, .tflite)',
        'wakeword_sensitivity': 'Wakeword Sensitivity',
        'wakeword_sensitivity_info': 'Detection sensitivity (0.0=strict, 1.0=sensitive)',
        'wakeword_disabled': 'Disabled',
        'wakeword_ppn': 'PPN (Picovoice - Recommended for Pi Zero 2W)',
        'wakeword_onnx': 'ONNX (Custom trained models)',
        'wakeword_tflite': 'TFLite (TensorFlow Lite)',
        
        # GPIO Button Settings
        'gpio_button_controls': '🔘 GPIO Button Controls',
        'enable_gpio_button': 'Enable GPIO Button',
        'gpio_button_info': 'Use physical button as wakeword alternative',
        'gpio_pin_number': 'GPIO Pin Number',
        'gpio_pin_info': 'GPIO pin for button (default: 17)',
        'enable_voice_cycling': 'Enable Voice Cycling',
        'voice_cycling_info': 'Double-tap button to cycle between voices',
        'long_press_duration': 'Long Press Duration (seconds)',
        'long_press_info': 'Hold time for shutdown command',
        ...
        'error_transcribing': 'Error transcribing audio',
